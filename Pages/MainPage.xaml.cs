...
public partial class MainPage : ContentPage
{
    ...
    public MainPage()
    {
        ...
        _workspaceService = services?.GetService<IWorkspaceService>() ?? new WorkspaceStore();
        _drawingPersistenceService = services?.GetService<IDrawingPersistenceService>() ?? new DrawingStateStore();
